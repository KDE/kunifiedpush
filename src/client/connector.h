...
/*!
 * \class KUnifiedPush::Connector
 * \inmodule KUnifiedPush
 * \brief Client connector to UnifiedPush.
 *
...
public:
     ...
     *
     *  \a serviceName The application identifier, same as used for registration
     ...
     *
     *  \a description A human-readable explanation what push notifications are used
     *  for by this application.
     *  \sa setVapidPublicKey
     */
    ...
    /*!
     * \enum KUnifiedPush::Connector::State
     * \brief Connector state.
     * \value Unregistered
     ...
     *
     *  \note This should be either called before calling registerClient() or vapidPublicKeyRequired should
     *  be set to \c true.
     *
     *  \sa RFC 8292
     *
     ...
     *
     *  \note This returns the raw 65 byte key data, application server APIs
     ...
     */
      ...
      *  automatically decrypted.
      *
      *  \note This returns the raw 16 byte key data, application server APIs
      *  typically want this in e.g. Base64 URL encoding.
      *
      *  \sa RFC 8291
      *
